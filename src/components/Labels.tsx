...
const Labels: React.FC<LabelsProps> = memo(
  ({ labels, setLabels, selectedLabelIndex, setSelectedLabelIndex }) => {
      ...
      <div className="p-4 h-full bg-gray-800 rounded-md flex flex-col">
        ...
        {labels.length > 0 ? (
          ...
          <p className="text-gray-400 mb-4">
            No labels. Add one and click on it to select it and start
            annotating. Restart to delete all information.
          </p>
        )}
