...
export { getData, postData, postImage, patchAnnotation }
...
const postImage = async (imageFile: APIImage) => {
  postData("/images", JSON.stringify(imageFile))
}

const patchAnnotation = async (imageName: string, annotation: Annotation) => {
